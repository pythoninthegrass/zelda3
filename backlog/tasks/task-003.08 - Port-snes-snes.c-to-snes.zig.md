...
Port snes/snes.c (top-level SNES machine wiring that ties cpu/ppu/apu/dma together) to idiomatic Zig, matching C-ABI symbols so callers link unchanged.
<!-- SECTION:DESCRIPTION:END -->

## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 snes.c is removed from the C build and snes.zig is compiled instead
