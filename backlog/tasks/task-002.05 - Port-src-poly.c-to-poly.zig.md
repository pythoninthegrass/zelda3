...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 poly.c is removed from the C build and poly.zig is compiled instead
- [x] #2 The intro/attract-mode polyhedral effect renders identically
