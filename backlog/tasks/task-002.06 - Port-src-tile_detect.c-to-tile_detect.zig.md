...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 tile_detect.c is removed from the C build and tile_detect.zig is compiled instead
- [x] #2 Tile collision behavior is unchanged across a full playthrough segment
